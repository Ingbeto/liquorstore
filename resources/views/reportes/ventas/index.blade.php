                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="date" name="fecha_inicial"  class="form-control" value="{{isset($_GET['fecha_inicial']) ? $_GET['fecha_inicial'] : '' }}" placeholder="Desde"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="date" name="fecha_final"  class="form-control" placeholder="Hasta" value="{{isset($_GET['fecha_final']) ? $_GET['fecha_final'] : '' }}"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
