                ...
                <table id="example1" class="table table-bordered table-striped table-hover">
                    ...
                    @foreach($usuarios as $usuario)
                        <tr>
                            ...
                            <td>
                                <form action="{{route('usuario.operaciones')}}" method="POST">
                                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                                    <input type="hidden" name="id" value="{{$usuario->identificacion}}" />
                                    <button class="btn btn-success" style="color: green; margin-left: 10px;" type="submit" data-toggle="tooltip" data-placement="top" title="Editar Usuario">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('usuario.cambiarPass')}}" method="POST">
                        <input type="hidden" name="_token" value="{{csrf_token()}}">
