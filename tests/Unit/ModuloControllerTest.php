...
class ModuloControllerTest extends TestCase
{
     ...
     */
    public function CP2_modulo_cant_regis_using_invalid_data($formInput, $formInputValue, $message) :void
    {
        $response = $this->post(route('modulo.store'), array_replace($this->formFields, [$formInput=>$formInputValue]));
